...
//			ArgumentBuilder.agent("traffic-light-1", TrafficLightAgent.class,"10000, 0, 5") +
			ArgumentBuilder.agent("traffic-light-1", TrafficLightAgent.class,"0, 0, 10, 10000, 1") +
			ArgumentBuilder.agent("traffic-light-2", TrafficLightAgent.class, "1, 0, 10, 10000, 0") +
