...
public class TrackRunnerBehaviour extends SimpleBehaviour{
	...
	public TrackRunnerBehaviour(RobotAgent agent) {
		super(agent);
	...
	private static final long serialVersionUID = -1011290537070691192L;
}
