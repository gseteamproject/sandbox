...
import common.remote.RemoteManager;
import common.remote.TSDaemon;
import common.testSuite.TestSuiteAgent;
import common.testerAgentControlOntology.TestResult;
import common.xml.FunctionalityDescriptor;
import common.xml.TestsTree;
...
// Gui states used to enable/disable buttons
  ...
  private common.testSuite.gui.CounterPanel    counterPanel;
  private javax.swing.JButton                       debugB;
  private javax.swing.JButton                       exitB;
  private common.testSuite.gui.FailedTestsView failedTestsView;
  ...
  private common.testSuite.gui.ProgressBar     progressBar;
  ...
  private common.xml.TestsTree                 testsTree;
  ...
  public TestSuiteGui(TestSuiteAgent myAgent, String xmlFileName) {
    ...
    jStatusLabel.setText("Current logger type: "+common.Logger.getLogger().getLoggerStringType()+", click on Logger button to change it");
  }
  ...
  private void initComponents() {    // GEN-BEGIN:initComponents
    ...
    progressBar = new common.testSuite.gui.ProgressBar();
    jSplitPane = new javax.swing.JSplitPane();
    failedTestsView = new common.testSuite.gui.FailedTestsView();
    testsTree = new common.xml.TestsTree();
    ...
    counterPanel = new common.testSuite.gui.CounterPanel();
...
*/
   ...
   * @see common.testSuite.gui.CounterPanel#reset(boolean,boolean)
   * @see common.testSuite.gui.ProgressBar#reset()
   */
