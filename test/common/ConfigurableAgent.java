...
import common.agentConfigurationOntology.AddBehaviour;
import common.agentConfigurationOntology.AgentConfigurationOntology;
import common.agentConfigurationOntology.LoadLanguage;
import common.agentConfigurationOntology.LoadOntology;
import common.agentConfigurationOntology.RemoveBehaviour;
		...
		addBehaviour(new AchieveREResponder(this, mt) {			
			...
			protected ACLMessage prepareResultNotification(ACLMessage request, ACLMessage response)
				...
				try {
					...
					} else if (ce instanceof common.agentConfigurationOntology.Quit) {
